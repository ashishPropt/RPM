...
<nav class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-actions">
            <?php if ($isLoggedIn): ?>
                <span style="font-size:0.82rem;color:var(--text-muted);padding:0 0.5rem;">
                    <?= htmlspecialchars($userName) ?>
                    <span class="badge badge-<?= $userRole === 'admin' ? 'gold' : 'green' ?>" style="margin-left:0.4rem;"><?= ucfirst($userRole) ?></span>
                </span>
